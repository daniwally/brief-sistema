        ...
        {loading ? (
          <div className="space-y-4 py-4">
            <div className="relative mx-auto w-16 h-16">
              ...
              <div className="absolute inset-3 rounded-full border-4 border-transparent border-b-emerald-300 animate-spin [animation-direction:reverse] [animation-duration:1.5s]" />
              <svg className="absolute inset-0 m-auto w-5 h-5 text-emerald-500 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="mx-auto w-48 h-1.5 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full animate-[loading_2s_ease-in-out_infinite]" />
            </div>
          </div>
        ) : (
